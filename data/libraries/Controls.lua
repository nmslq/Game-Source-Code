function Controls()
   if android then
     ...
     shaders.setObjectCamera('controls','CameraControls')
     testAndroidControls()
     flxAndroidControls()
